...
class AutocompleteWindow(object):
    ...
    def show(self, public, private, is_case_insen, start_len):
        ...
        self.connect(self.treeview, "button-press-event", self.on_tv_button_press)
    ...
    def update_list(self):
        ...
        sb = self.sourcebuffer
        prefix = get_text(
            sb, sb.get_iter_at_mark(self.mark), sb.get_iter_at_mark(sb.get_insert())
        )
        ...
        if start == end:
            ...
            if start2 != end2:
                ...
                self.changed_after_hide_handler = sb.connect(
                    "changed",
                    self.on_changed_after_hide,
                    expected_text,
                    public,
                    private,
                    self.is_case_insen,
    ...
    def on_changed_after_hide(
        self, sb, expected_text, public, private, is_case_insen, start_len
    ):
        """
