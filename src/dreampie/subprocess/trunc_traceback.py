...
from dreampie.py2to3 import basestring, long, py3k, unicode, xrange
...
def trunc_traceback(exc_info, source_file):
    """
    ...
    _typ, value, tb = exc_info  # Unpack the tuple inside the function
